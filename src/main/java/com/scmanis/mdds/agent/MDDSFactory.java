...
public class MDDSFactory {

    public static MDDSAgent getAgent() {
...
//        MDDSAgent agent = new MDDSAgent(literalList);
//        agent.tell("A01^A02^A03^A04^A05^A06^A07=>Paranoid;4");
//        agent.tell("A08^A09^A10^A11^A12^A13^A14=>Schizoid;4");
//        agent.tell("A15^A16^A17^A18^A19^A20^A21^A22^A23=>Schizotypal;4");
//        agent.tell("B11^B12^B13^B14^B15^B16^B17=>Antisocial;3");
//        agent.tell("B21^B22^B23^B24^B25^B26^B27^B28=>Borderline;5");
//        agent.tell("B31^B32^B33^B34^B35^B36^B37=>Histrionic;5");
//        agent.tell("B41^B42^B43^B44^B45^B46^B47^B48^B49=>Narcissistic;5");
//        agent.tell("C01^C02^C03^C04^C05^C06=>Avoidant;4");
//        agent.tell("C11^C12^C13^C14^C15^C16^C17^C18^C19=>Dependent;5");
//        agent.tell("C21^C22^C23^C24^C25^C26^C27^C28^C29=>OCD;4");
